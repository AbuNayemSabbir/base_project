...
class TTextTheme {
  ...
  static const TextTheme lightTextTheme = TextTheme(
    ...
    titleMedium: TextStyle(fontSize: 18.0, fontWeight: FontWeight.normal, color: Colors.black),
    titleSmall: TextStyle(fontSize: 14.0, fontWeight: FontWeight.normal, color: Colors.black),
  ...
  static const TextTheme darkTextTheme = TextTheme(
    ...
    titleMedium: TextStyle(fontSize: 18.0, fontWeight: FontWeight.normal, color: Colors.white),
